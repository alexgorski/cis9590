...
class EndorsementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endorsement" do
    assert_difference('Endorsement.count') do
      post endorsements_url, params: { endorsement: { brand: @endorsement.brand, notes: @endorsement.notes, player_id: @endorsement.player_id } }
    end
  ...
  test "should update endorsement" do
    patch endorsement_url(@endorsement), params: { endorsement: { brand: @endorsement.brand, notes: @endorsement.notes, player_id: @endorsement.player_id } }
