...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post coaches_url, params: { coach: { firstname: @coach.firstname, lastname: @coach.lastname, team_id: @coach.team_id, yearstart: @coach.yearstart } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { firstname: @coach.firstname, lastname: @coach.lastname, team_id: @coach.team_id, yearstart: @coach.yearstart } }
